...
func TestPlayerComponentCreatesSettlesAndRestoresSnapshot(t *testing.T) {
	...
	settlementPayload, _ := proto.Marshal(&internalpb.SettlementRequest{SettlementId: "settlement-1", PlayerId: response.PlayerId, AssetType: "gold", Delta: 125, Reason: "battle_settlement", Source: "battle"})
	...
	conflictingPayload, _ := proto.Marshal(&internalpb.SettlementRequest{SettlementId: "settlement-1", PlayerId: response.PlayerId, AssetType: "gold", Delta: 126, Reason: "battle_settlement", Source: "battle"})
